...
function AboutHistory() {
    ...
    return (
        <div className="min-h-screen bg-[#001f3f] text-white font-sans overflow-x-hidden selection:bg-yellow-400 selection:text-blue-900">
            ...
            <main className="relative z-10 max-w-5xl mx-auto px-6 pt-24 md:pt-40 pb-24 space-y-20">
                {/* Hero section */}
            ...
            {/* Footer */}
            <footer className="py-12 px-6 text-center border-t border-white/10 mt-16 max-w-7xl mx-auto">
