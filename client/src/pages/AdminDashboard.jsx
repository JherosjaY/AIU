        ...
        <nav className="space-y-2 flex-1 overflow-y-auto pr-2 custom-scrollbar">
          ...
          {[
            ...
            <button
              ...
              className={`w-full group flex items-center gap-4 px-6 py-4 rounded-2xl font-bold text-[11px] uppercase tracking-widest transition-all whitespace-nowrap ${
        ...
        <div className="p-6 md:p-10 flex flex-col md:flex-row md:items-center justify-between border-b border-gray-200 bg-white gap-6">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <button 
              ...
              className={`p-3 rounded-xl transition-all border border-gray-200 md:border-transparent ${
                isRefreshing ? 'bg-blue-50 text-blue-600 border-blue-100 shadow-inner' : 'bg-gray-50 md:bg-gray-100 text-gray-400 hover:text-blue-600 hover:bg-blue-50 hover:border-blue-100'
              }`}
            >
                  ...
                  {[
                    ...
                    <div 
                      ...
                      className={`group flex items-center justify-between p-3 rounded-xl border transition-all cursor-pointer ${
                        selectedStudent[req.id] ? 'bg-emerald-50 border-emerald-100 text-emerald-700' : 'bg-white border-gray-100 text-gray-400 grayscale hover:grayscale-0 hover:border-blue-200 hover:shadow-sm'
                      }`}
                    >
                      ...
                      <div className={`w-5 h-5 rounded-lg flex items-center justify-center border ${
                        selectedStudent[req.id] ? 'bg-emerald-500 border-emerald-400 text-white' : 'bg-white border-gray-200'
                      }`}>
